...
namespace Revolt.Net.Commands.Attributes
{
    ...
    public abstract class ParameterPreconditionAttribute : Attribute
    {
        ...
        public abstract Task<PreconditionResult> CheckPermissionsAsync(ICommandContext context, CommandParameterInfo parameter, object value, IServiceProvider services);
    }
}
