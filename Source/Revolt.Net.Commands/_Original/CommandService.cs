...
namespace Revolt.Net.Commands._Original
{
    ...
    ///         <see cref="Log" /> for any command-related log events, and
    ...
    public class CommandService : IDisposable
    {
        ...
        public SearchResult Search(ICommandContext context, int argPos)
            => Search(context.Arguments.Substring(argPos));
        /// <summary>
        ///     Searches for the command.
        /// </summary>
        /// <param name="context">The context of the command.</param>
        ...
        public Task<IResult> ExecuteAsync(ICommandContext context, int argPos, IServiceProvider services, MultiMatchHandling multiMatchHandling = MultiMatchHandling.Exception)
            => ExecuteAsync(context, context.Arguments.Substring(argPos), services, multiMatchHandling);
        /// <summary>
        ///     Executes the command.
        /// </summary>
        /// <param name="context">The context of the command.</param>
        ...
        public async Task<IResult> ExecuteAsync(ICommandContext context, string input, IServiceProvider services, MultiMatchHandling multiMatchHandling = MultiMatchHandling.Exception)
        {
            ...
            {
                await _commandExecutedEvent.InvokeAsync(new Optional<CommandInfo>(), context, searchResult).ConfigureAwait(false);
                return searchResult;
            }
